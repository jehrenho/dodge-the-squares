...
export class Menu {
    ...
    private calculatePositioning(): void {
        ...
        let totalHTPHeight: number = MENU_CONFIG.HTPVerSizeFactor * this.virtualHeight;
        ...
        let totalModExHeight: number = MENU_CONFIG.modExVertSizeFactor * this.virtualHeight;
