import { MODIFIER_TYPE, COLLISION_ROLE, COLLISION_ACTION, collisionMatrix, MOD_EFFECT_CONFIG } from './config.js';
...
export class CollisionUtil {
    ...
    static resolveModifierCollisions() {
        // detect new collisions
        let modifierCollisions = CollisionUtil.modifierManager.detectCollisions(CollisionUtil.player);
    ...
    static resolveHazardCollisions() {
        // detect new collisions
        let hazardCollisions = CollisionUtil.hazardManager.detectCollisions(CollisionUtil.player);
