...
export class Flasher {
    ...
    static startFlashingCollision(player, shapesToFlash) {
...
Flasher.framesRemainingThisFlash = GAME_CONFIG.framesPerFlash;
Flasher.flashFillColour = GAME_CONFIG.collisionFlashFillColour;
Flasher.flashBorderColour = GAME_CONFIG.collisionFlashBorderColour;
Flasher.flashingFramesRemaining = 0;
Flasher.isFlashOnNow = true;
